...
/*
    < PL / SQL >
    PROCEDURE LANGUAGE EXTENSTION TO SQL)(프로시져)
...
---------------------------------실습문제----------------------------------------
-- 1. 사원의 연봉을 구하는 PL/SQL 블럭 작성, 보너스가 있는 사원은 보너스도 포함하여 계산 , 사번 입력
-- 보너스가 없으면 보너스 미포함 연봉
-- 보너스가 있으면 보너스 포함 연봉
-- 출력예시
...
-- 90점 이상은 'A',  80점 이상 'B',  70점이상 'C',  60점이상 'D', 60미만은 'F'
-- GRADE 변수에 저장
...
/*
    ...
    [ 표현식 ]
    FOR 변수 IN [REVERSE -> 값을 점점 작아지게 하고싶으면..] 초기값..최종값
    LOOP
        반복적으로 실행할 구문;
    END LOOP;
*/
...
/*
    ...
    EXCEPTION
        ...
        ...
        WHEN OTHERS THEN 예외처리구문N; --> OTHERS 는 부모처럼 오류들을 모두 포함
        ...
        * 시스템 예외 (오라클에서 미리 정의해둔 예외)
        ...
        - DUP_VAL_ON_INDEX  : UNIQUE 제약조건에 위배 되었을경우
        ...
*/
